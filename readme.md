...
The AllsTo connector to Solana is the SDK connector to the Solana smart contract which processes the all inbound and outbound on-chain transactions of AllsTo payment on Solana blockchains. It wrapped with Solana SDK and is the main AllsTo interface to the Solana blockchains.
